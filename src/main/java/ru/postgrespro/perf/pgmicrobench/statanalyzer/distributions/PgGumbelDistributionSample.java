...
public class PgGumbelDistributionSample implements PgDistributionSample {
    ...
    public PgGumbelDistributionSample() {
        this(0, 1);
    }

    public PgGumbelDistributionSample(double location) {
        this(location, 1);
    }
     ...
     * Gumbel distribution.
     */
    public PgGumbelDistributionSample(double location, double scale) {
        if (scale <= 0) {
    ...
    public static List<Double> generate(Random random,
                                        ...
                                        double scale,
                                        int count) {
        PgGumbelDistributionSample distribution = new PgGumbelDistributionSample(location, scale);
