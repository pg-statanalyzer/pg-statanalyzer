...
public class CramerVonMises {
     ...
     */
    public static double computePValue(double statistic) {
        if (statistic <= 0) {
     ...
     */
    public static double computeA1Function(double s) {
        if (s <= 0) {
            throw new IllegalArgumentException("Statistic must be positive.");
        }
     ...
     */
    public static double modifiedBessel(double v, double z) {
        if (z < 0) {
     ...
     */
    public static double safeGammaRatio(double x1, double x2) {
        double logGammaDiff = Gamma.logGamma(x1) - Gamma.logGamma(x2);
        return Math.exp(logGammaDiff);
    }
