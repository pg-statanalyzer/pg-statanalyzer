...
public class Sample implements Iterable<Double> {
    ...
    @Getter(lazy = true)
    private final double skewness = lazyDescriptiveStatistics.get().getSkewness();

    @Getter(lazy = true)
    private final double kurtosis = lazyDescriptiveStatistics.get().getKurtosis();

    @Getter(lazy = true)
    private final double mean = lazyDescriptiveStatistics.get().getMean();

    @Getter(lazy = true)
    private final double standardDeviation = lazyDescriptiveStatistics.get().getStandardDeviation();

    @Getter(lazy = true)
    private final double variance = lazyDescriptiveStatistics.get().getVariance();
